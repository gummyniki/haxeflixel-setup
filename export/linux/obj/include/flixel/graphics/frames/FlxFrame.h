...
class HXCPP_CLASS_ATTRIBUTES FlxFrame_obj : public ::hx::Object
{
	...
	public:
		...
		::Dynamic setBorderTo_dyn();
		 ...
		 ::flixel::graphics::frames::FlxFrame clipTo( ::flixel::math::FlxRect rect, ::flixel::graphics::frames::FlxFrame clippedFrame);
		::Dynamic clipTo_dyn();

		bool overlaps( ::flixel::math::FlxRect rect);
		::Dynamic overlaps_dyn();

		bool contains( ::flixel::math::FlxRect rect);
		::Dynamic contains_dyn();

		bool isContained( ::flixel::math::FlxRect rect);
		::Dynamic isContained_dyn();

		 ::flixel::graphics::frames::FlxFrame clip( ::flixel::math::FlxRect rect);
		::Dynamic clip_dyn();
