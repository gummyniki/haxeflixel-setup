...
class HXCPP_CLASS_ATTRIBUTES Interaction_obj : public  ::flixel::_hx_system::debug::Window_obj
{
	...
	public:
		...
		bool objectBelongsToDebugger( ::Dynamic object);
		::Dynamic objectBelongsToDebugger_dyn();
		...
		void registerCustomCursor(::String name, ::openfl::display::BitmapData icon,::hx::Null< Float >  offsetX,::hx::Null< Float >  offsetY);
		...
		bool isOverObject( ::flixel::FlxObject object, ::flixel::math::FlxRect area);
		::Dynamic isOverObject_dyn();

		bool isOverSprite( ::flixel::FlxSprite sprite, ::flixel::math::FlxRect area);
		::Dynamic isOverSprite_dyn();
		...
		Float toDebugX(Float worldX, ::flixel::FlxCamera camera);
		::Dynamic toDebugX_dyn();

		Float toDebugY(Float worldY, ::flixel::FlxCamera camera);
		::Dynamic toDebugY_dyn();
