...
class HXCPP_CLASS_ATTRIBUTES FlxSprite_obj : public  ::flixel::FlxObject_obj
{
	...
	public:
		...
		bool useColorTransform;
		 ...
		 ::flixel::math::FlxRect _lastClipRect;
		...
		void drawFrameComplex( ::flixel::graphics::frames::FlxFrame frame, ::flixel::FlxCamera camera);
		::Dynamic drawFrameComplex_dyn();
		...
		::Dynamic hasColorTransform_dyn();

		bool hasColorTransformRaw();
		::Dynamic hasColorTransformRaw_dyn();
