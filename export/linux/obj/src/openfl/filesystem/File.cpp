...
HX_LOCAL_STACK_FRAME(_hx_pos_19861550b6f626f4_2155_get_isHidden,"openfl.filesystem.File","get_isHidden",0x640f88ea,"openfl.filesystem.File.get_isHidden","openfl/filesystem/File.hx",2155,0x4a92e11d)
...
HX_LOCAL_STACK_FRAME(_hx_pos_19861550b6f626f4_2042_get_lineEnding,"openfl.filesystem.File","get_lineEnding",0x64907671,"openfl.filesystem.File.get_lineEnding","openfl/filesystem/File.hx",2042,0x4a92e11d)
HX_LOCAL_STACK_FRAME(_hx_pos_19861550b6f626f4_2069_get_separator,"openfl.filesystem.File","get_separator",0xa05fa9af,"openfl.filesystem.File.get_separator","openfl/filesystem/File.hx",2069,0x4a92e11d)
...
static const ::String _hx_array_data_f6f882a1_91[] = {
...
HXLINE(2129)			if ((path.indexOf(HX_("\\",5c,00,00,00),null()) > 0)) {
...
bool File_obj::get_isHidden(){
            	HX_STACKFRAME(&_hx_pos_19861550b6f626f4_2155_get_isHidden)
HXDLIN(2155)		return (this->get_name().charAt(0) == HX_(".",2e,00,00,00));
            	}
...
::String File_obj::get_lineEnding(){
            	HX_STACKFRAME(&_hx_pos_19861550b6f626f4_2042_get_lineEnding)
HXDLIN(2042)		return HX_("\n",0a,00,00,00);
            	}
...
::String File_obj::get_separator(){
            	HX_STACKFRAME(&_hx_pos_19861550b6f626f4_2069_get_separator)
HXDLIN(2069)		return HX_("/",2f,00,00,00);
            	}
...
HXDLIN( 434)		_hx___driveLetters = ::Array_obj< ::String >::fromData( _hx_array_data_f6f882a1_91,26);
            	}
}
