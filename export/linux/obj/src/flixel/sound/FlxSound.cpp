...
HX_LOCAL_STACK_FRAME(_hx_pos_119249e340fa9820_715_onFocusLost,"flixel.sound.FlxSound","onFocusLost",0x014954bd,"flixel.sound.FlxSound.onFocusLost","flixel/sound/FlxSound.hx",715,0x5a8e478e)
HX_LOCAL_STACK_FRAME(_hx_pos_119249e340fa9820_723_set_group,"flixel.sound.FlxSound","set_group",0x1bf66ba2,"flixel.sound.FlxSound.set_group","flixel/sound/FlxSound.hx",723,0x5a8e478e)
HX_LOCAL_STACK_FRAME(_hx_pos_119249e340fa9820_739_get_playing,"flixel.sound.FlxSound","get_playing",0xcfd5df85,"flixel.sound.FlxSound.get_playing","flixel/sound/FlxSound.hx",739,0x5a8e478e)
HX_LOCAL_STACK_FRAME(_hx_pos_119249e340fa9820_744_get_volume,"flixel.sound.FlxSound","get_volume",0x9b5529a3,"flixel.sound.FlxSound.get_volume","flixel/sound/FlxSound.hx",744,0x5a8e478e)
HX_LOCAL_STACK_FRAME(_hx_pos_119249e340fa9820_748_set_volume,"flixel.sound.FlxSound","set_volume",0x9ed2c817,"flixel.sound.FlxSound.set_volume","flixel/sound/FlxSound.hx",748,0x5a8e478e)
HX_LOCAL_STACK_FRAME(_hx_pos_119249e340fa9820_757_get_pitch,"flixel.sound.FlxSound","get_pitch",0x61518817,"flixel.sound.FlxSound.get_pitch","flixel/sound/FlxSound.hx",757,0x5a8e478e)
HX_LOCAL_STACK_FRAME(_hx_pos_119249e340fa9820_761_set_pitch,"flixel.sound.FlxSound","set_pitch",0x44a27423,"flixel.sound.FlxSound.set_pitch","flixel/sound/FlxSound.hx",761,0x5a8e478e)
HX_LOCAL_STACK_FRAME(_hx_pos_119249e340fa9820_781_get_pan,"flixel.sound.FlxSound","get_pan",0x041589f4,"flixel.sound.FlxSound.get_pan","flixel/sound/FlxSound.hx",781,0x5a8e478e)
HX_LOCAL_STACK_FRAME(_hx_pos_119249e340fa9820_785_set_pan,"flixel.sound.FlxSound","set_pan",0xf7171b00,"flixel.sound.FlxSound.set_pan","flixel/sound/FlxSound.hx",785,0x5a8e478e)
HX_LOCAL_STACK_FRAME(_hx_pos_119249e340fa9820_793_get_time,"flixel.sound.FlxSound","get_time",0x916e1796,"flixel.sound.FlxSound.get_time","flixel/sound/FlxSound.hx",793,0x5a8e478e)
HX_LOCAL_STACK_FRAME(_hx_pos_119249e340fa9820_797_set_time,"flixel.sound.FlxSound","set_time",0x3fcb710a,"flixel.sound.FlxSound.set_time","flixel/sound/FlxSound.hx",797,0x5a8e478e)
HX_LOCAL_STACK_FRAME(_hx_pos_119249e340fa9820_808_get_length,"flixel.sound.FlxSound","get_length",0xdb0994af,"flixel.sound.FlxSound.get_length","flixel/sound/FlxSound.hx",808,0x5a8e478e)
HX_LOCAL_STACK_FRAME(_hx_pos_119249e340fa9820_813_toString,"flixel.sound.FlxSound","toString",0xfd2560ac,"flixel.sound.FlxSound.toString","flixel/sound/FlxSound.hx",813,0x5a8e478e)
namespace flixel{
namespace sound{
...
HXDLIN( 709)		if (!(this->_alreadyPaused)) {
HXLINE( 710)			this->resume();
            		}
            	}
...
void FlxSound_obj::onFocusLost(){
            	HX_STACKFRAME(&_hx_pos_119249e340fa9820_715_onFocusLost)
HXLINE( 716)		this->_alreadyPaused = this->_paused;
HXLINE( 717)		this->pause();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxSound_obj,onFocusLost,(void))
 ...
 ::flixel::sound::FlxSoundGroup FlxSound_obj::set_group( ::flixel::sound::FlxSoundGroup value){
            	HX_STACKFRAME(&_hx_pos_119249e340fa9820_723_set_group)
HXLINE( 724)		if (::hx::IsNotNull( value )) {
HXLINE( 727)			value->add(::hx::ObjectPtr<OBJ_>(this));
            		}
            		else {
HXLINE( 732)			this->group->remove(::hx::ObjectPtr<OBJ_>(this));
            		}
...
bool FlxSound_obj::get_playing(){
            	HX_STACKFRAME(&_hx_pos_119249e340fa9820_739_get_playing)
HXDLIN( 739)		return ::hx::IsNotNull( this->_channel );
            	}
...
Float FlxSound_obj::get_volume(){
            	HX_STACKFRAME(&_hx_pos_119249e340fa9820_744_get_volume)
HXDLIN( 744)		return this->_volume;
            	}
...
Float FlxSound_obj::set_volume(Float Volume){
            	HX_STACKFRAME(&_hx_pos_119249e340fa9820_748_set_volume)
HXLINE( 749)		Float lowerBound;
HXDLIN( 749)		if ((Volume < 0)) {
HXLINE( 749)			lowerBound = ( (Float)(0) );
            		}
            		else {
HXLINE( 749)			lowerBound = Volume;
            		}
HXDLIN( 749)		Float _hx_tmp;
HXDLIN( 749)		if ((lowerBound > 1)) {
HXLINE( 749)			_hx_tmp = ( (Float)(1) );
            		}
            		else {
HXLINE( 749)			_hx_tmp = lowerBound;
            		}
HXDLIN( 749)		this->_volume = _hx_tmp;
HXLINE( 750)		this->updateTransform();
HXLINE( 751)		return Volume;
            	}
...
Float FlxSound_obj::get_pitch(){
            	HX_STACKFRAME(&_hx_pos_119249e340fa9820_757_get_pitch)
HXDLIN( 757)		return this->_pitch;
            	}
...
Float FlxSound_obj::set_pitch(Float v){
            	HX_STACKFRAME(&_hx_pos_119249e340fa9820_761_set_pitch)
HXLINE( 762)		if (::hx::IsNotNull( this->_channel )) {
HXLINE( 770)			if (::hx::IsNotNull( this->_channel->_hx___audioSource )) {
HXLINE( 771)				this->_channel->_hx___audioSource->set_pitch(v);
            			}
            		}
HXLINE( 775)		return (this->_pitch = v);
            	}
...
Float FlxSound_obj::get_pan(){
            	HX_STACKFRAME(&_hx_pos_119249e340fa9820_781_get_pan)
HXDLIN( 781)		return this->_transform->pan;
            	}
...
Float FlxSound_obj::set_pan(Float pan){
            	HX_STACKFRAME(&_hx_pos_119249e340fa9820_785_set_pan)
HXLINE( 786)		this->_transform->pan = pan;
HXLINE( 787)		this->updateTransform();
HXLINE( 788)		return pan;
            	}
...
Float FlxSound_obj::get_time(){
            	HX_STACKFRAME(&_hx_pos_119249e340fa9820_793_get_time)
HXDLIN( 793)		return this->_time;
            	}
...
Float FlxSound_obj::set_time(Float time){
            	HX_STACKFRAME(&_hx_pos_119249e340fa9820_797_set_time)
HXLINE( 798)		if (::hx::IsNotNull( this->_channel )) {
HXLINE( 800)			this->cleanup(false,true);
HXLINE( 801)			this->startSound(time);
            		}
HXLINE( 803)		return (this->_time = time);
            	}
...
Float FlxSound_obj::get_length(){
            	HX_STACKFRAME(&_hx_pos_119249e340fa9820_808_get_length)
HXDLIN( 808)		return this->_length;
            	}
...
::String FlxSound_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_119249e340fa9820_813_toString)
HXLINE( 814)		 ::Dynamic value = ::hx::IsNotNull( this->_channel );
HXDLIN( 814)		 ::flixel::util::LabelValuePair _this = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN( 814)		_this->label = HX_("playing",6e,0f,18,8a);
HXDLIN( 814)		_this->value = value;
HXLINE( 815)		 ::Dynamic value1 = this->_time;
HXDLIN( 815)		 ::flixel::util::LabelValuePair _this1 = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN( 815)		_this1->label = HX_("time",0d,cc,fc,4c);
HXDLIN( 815)		_this1->value = value1;
HXLINE( 816)		 ::Dynamic value2 = this->_length;
HXDLIN( 816)		 ::flixel::util::LabelValuePair _this2 = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN( 816)		_this2->label = HX_("length",e6,94,07,9f);
HXDLIN( 816)		_this2->value = value2;
HXLINE( 817)		 ::Dynamic value3 = this->_volume;
HXDLIN( 817)		 ::flixel::util::LabelValuePair _this3 = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN( 817)		_this3->label = HX_("volume",da,29,53,5f);
HXDLIN( 817)		_this3->value = value3;
HXLINE( 813)		return ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(4)->init(0,_this)->init(1,_this1)->init(2,_this2)->init(3,_this3));
            	}
