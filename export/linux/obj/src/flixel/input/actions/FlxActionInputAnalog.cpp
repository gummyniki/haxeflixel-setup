...
HX_DEFINE_STACK_FRAME(_hx_pos_11dc5d554a568b00_310_new,"flixel.input.actions.FlxActionInputAnalog","new",0x759b504b,"flixel.input.actions.FlxActionInputAnalog.new","flixel/input/actions/FlxActionInputAnalog.hx",310,0x00ad3122)
HX_LOCAL_STACK_FRAME(_hx_pos_11dc5d554a568b00_331_check,"flixel.input.actions.FlxActionInputAnalog","check",0x3bce2973,"flixel.input.actions.FlxActionInputAnalog.check","flixel/input/actions/FlxActionInputAnalog.hx",331,0x00ad3122)
HX_LOCAL_STACK_FRAME(_hx_pos_11dc5d554a568b00_368_checkAxis,"flixel.input.actions.FlxActionInputAnalog","checkAxis",0x0afda7b4,"flixel.input.actions.FlxActionInputAnalog.checkAxis","flixel/input/actions/FlxActionInputAnalog.hx",368,0x00ad3122)
HX_LOCAL_STACK_FRAME(_hx_pos_11dc5d554a568b00_374_updateValues,"flixel.input.actions.FlxActionInputAnalog","updateValues",0xef275580,"flixel.input.actions.FlxActionInputAnalog.updateValues","flixel/input/actions/FlxActionInputAnalog.hx",374,0x00ad3122)
HX_LOCAL_STACK_FRAME(_hx_pos_11dc5d554a568b00_319_boot,"flixel.input.actions.FlxActionInputAnalog","boot",0x6a63f1e7,"flixel.input.actions.FlxActionInputAnalog.boot","flixel/input/actions/FlxActionInputAnalog.hx",319,0x00ad3122)
HX_LOCAL_STACK_FRAME(_hx_pos_11dc5d554a568b00_320_boot,"flixel.input.actions.FlxActionInputAnalog","boot",0x6a63f1e7,"flixel.input.actions.FlxActionInputAnalog.boot","flixel/input/actions/FlxActionInputAnalog.hx",320,0x00ad3122)
namespace flixel{
namespace input{
namespace actions{
...
void FlxActionInputAnalog_obj::__construct( ::flixel::input::actions::FlxInputDevice Device,int InputID,int Trigger,::hx::Null< int >  __o_Axis,::hx::Null< int >  __o_DeviceID){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_11dc5d554a568b00_310_new)
HXLINE( 315)		this->y = ((Float)0);
HXLINE( 314)		this->x = ((Float)0);
HXLINE( 324)		super::__construct(::flixel::input::actions::FlxInputType_obj::ANALOG_dyn(),Device,InputID,Trigger,DeviceID);
HXLINE( 325)		this->axis = Axis;
HXLINE( 326)		this->xMoved =  ::flixel::input::FlxInput_obj::__alloc( HX_CTX ,0);
HXLINE( 327)		this->yMoved =  ::flixel::input::FlxInput_obj::__alloc( HX_CTX ,1);
            	}
...
bool FlxActionInputAnalog_obj::check( ::flixel::input::actions::FlxAction Action){
            	HX_STACKFRAME(&_hx_pos_11dc5d554a568b00_331_check)
HXLINE( 332)		bool returnVal;
HXDLIN( 332)		switch((int)(this->axis)){
            			case (int)0: {
HXLINE( 334)				int state = this->xMoved->current;
HXDLIN( 334)				switch((int)(this->trigger)){
            					case (int)-1: {
HXLINE( 332)						returnVal = (state == -1);
            					}
            					break;
            					case (int)0: {
HXLINE( 334)						if ((state != 0)) {
HXLINE( 332)							returnVal = (state == -1);
            						}
            						else {
HXLINE( 332)							returnVal = true;
            						}
            					}
            					break;
            					case (int)1: {
HXLINE( 334)						if ((state != 1)) {
HXLINE( 332)							returnVal = (state == 2);
            						}
            						else {
HXLINE( 332)							returnVal = true;
            						}
...
HXLINE( 332)						returnVal = (state == 2);
            					...
            					break;
            					default:{
HXLINE( 332)						returnVal = false;
            					}
            				}
            			}
            			break;
            			case (int)1: {
HXLINE( 335)				int state1 = this->yMoved->current;
HXDLIN( 335)				switch((int)(this->trigger)){
            					case (int)-1: {
HXLINE( 332)						returnVal = (state1 == -1);
            					}
            					break;
            					case (int)0: {
HXLINE( 335)						if ((state1 != 0)) {
HXLINE( 332)							returnVal = (state1 == -1);
            						}
            						else {
HXLINE( 332)							returnVal = true;
            					...
            					break;
            					case (int)1: {
HXLINE( 335)						if ((state1 != 1)) {
HXLINE( 332)							returnVal = (state1 == 2);
            						}
            						else {
HXLINE( 332)							returnVal = true;
            						}
...
HXLINE( 332)						returnVal = false;
            			...
            			break;
            			case (int)2: {
HXLINE( 336)				int state2 = this->xMoved->current;
HXDLIN( 336)				bool returnVal1;
HXDLIN( 336)				switch((int)(this->trigger)){
            					case (int)-1: {
HXLINE( 336)						returnVal1 = (state2 == -1);
            					}
            					break;
            					case (int)0: {
HXLINE( 336)						if ((state2 != 0)) {
HXLINE( 336)							returnVal1 = (state2 == -1);
            						}
            						else {
HXLINE( 336)							returnVal1 = true;
            						}
            					}
            					break;
            					case (int)1: {
HXLINE( 336)						if ((state2 != 1)) {
HXLINE( 336)							returnVal1 = (state2 == 2);
            						}
            						else {
HXLINE( 336)							returnVal1 = true;
            						}
...
HXLINE( 336)						returnVal1 = (state2 == 2);
            					...
            					break;
            					default:{
HXLINE( 336)						returnVal1 = false;
            					}
            				}
HXDLIN( 336)				if (returnVal1) {
HXLINE( 336)					int state3 = this->yMoved->current;
HXDLIN( 336)					switch((int)(this->trigger)){
            						case (int)-1: {
HXLINE( 332)							returnVal = (state3 == -1);
            						}
            						break;
            						case (int)0: {
HXLINE( 336)							if ((state3 != 0)) {
HXLINE( 332)								returnVal = (state3 == -1);
            							}
            							else {
HXLINE( 332)								returnVal = true;
            						...
            						break;
            						case (int)1: {
HXLINE( 336)							if ((state3 != 1)) {
HXLINE( 332)								returnVal = (state3 == 2);
            							}
            							else {
HXLINE( 332)								returnVal = true;
            							}
...
HXLINE( 332)					returnVal = false;
            			...
            			break;
            			case (int)3: {
HXLINE( 340)				switch((int)(this->trigger)){
            					case (int)-1: {
HXLINE( 349)						bool returnVal2;
HXDLIN( 349)						if (this->checkAxis(true,-1)) {
HXLINE( 349)							returnVal2 = this->checkAxis(false,0);
            						}
            						else {
HXLINE( 349)							returnVal2 = false;
            						}
HXDLIN( 349)						if (!(returnVal2)) {
HXLINE( 351)							if (this->checkAxis(true,0)) {
HXLINE( 332)								returnVal = this->checkAxis(false,-1);
            							}
            							else {
HXLINE( 332)								returnVal = false;
            							}
...
HXLINE( 332)							returnVal = this->checkAxis(false,0);
            						}
            						else {
HXLINE( 332)							returnVal = true;
            						}
            					...
            					break;
            					case (int)1: {
HXLINE( 342)						if (!(this->checkAxis(true,1))) {
HXLINE( 332)							returnVal = this->checkAxis(false,1);
            						}
            						else {
HXLINE( 332)							returnVal = true;
            					...
            					break;
            					case (int)2: {
HXLINE( 345)						bool returnVal3;
HXDLIN( 345)						bool returnVal4;
HXDLIN( 345)						if (this->checkAxis(true,2)) {
HXLINE( 345)							returnVal4 = this->checkAxis(false,2);
            						}
            						else {
HXLINE( 345)							returnVal4 = false;
            						}
HXDLIN( 345)						if (!(returnVal4)) {
HXLINE( 346)							if (this->checkAxis(true,2)) {
HXLINE( 345)								returnVal3 = this->checkAxis(false,0);
            							}
            							else {
HXLINE( 345)								returnVal3 = false;
            							}
            						}
            						else {
HXLINE( 345)							returnVal3 = true;
            						}
HXDLIN( 345)						if (!(returnVal3)) {
HXLINE( 347)							if (this->checkAxis(true,0)) {
HXLINE( 332)								returnVal = this->checkAxis(false,2);
            							}
            							else {
HXLINE( 332)								returnVal = false;
            							}
...
HXLINE( 356)		if (returnVal) {
HXLINE( 358)			if (::hx::IsNull( Action->_x )) {
HXLINE( 359)				Action->_x = this->x;
            			}
HXLINE( 360)			if (::hx::IsNull( Action->_y )) {
HXLINE( 361)				Action->_y = this->y;
            			}
            		}
HXLINE( 364)		return returnVal;
            	}


bool FlxActionInputAnalog_obj::checkAxis(bool isX,int state){
            	HX_STACKFRAME(&_hx_pos_11dc5d554a568b00_368_checkAxis)
HXLINE( 369)		 ::flixel::input::FlxInput input;
HXDLIN( 369)		if (isX) {
HXLINE( 369)			input = this->xMoved;
            		}
            		else {
HXLINE( 369)			input = this->yMoved;
            		}
HXLINE( 370)		int state1 = input->current;
HXDLIN( 370)		switch((int)(state)){
            			case (int)-1: {
HXLINE( 370)				return (state1 == -1);
            			}
            			break;
            			case (int)0: {
HXLINE( 370)				if ((state1 != 0)) {
HXLINE( 370)					return (state1 == -1);
            				}
            				else {
HXLINE( 370)					return true;
            			...
            			break;
            			case (int)1: {
HXLINE( 370)				if ((state1 != 1)) {
HXLINE( 370)					return (state1 == 2);
            				}
            				else {
HXLINE( 370)					return true;
            				}
...
void FlxActionInputAnalog_obj::updateValues(Float X,Float Y){
            	HX_STACKFRAME(&_hx_pos_11dc5d554a568b00_374_updateValues)
HXLINE( 375)		if ((X != 0)) {
HXLINE( 377)			this->xMoved->press();
            		}
            		else {
HXLINE( 381)			this->xMoved->release();
            		}
HXLINE( 384)		if ((Y != 0)) {
HXLINE( 386)			this->yMoved->press();
            		}
            		else {
HXLINE( 390)			this->yMoved->release();
            		}
HXLINE( 393)		this->x = X;
HXLINE( 394)		this->y = Y;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_11dc5d554a568b00_319_boot)
HXDLIN( 319)		A_X = true;
            	}
{
            	HX_STACKFRAME(&_hx_pos_11dc5d554a568b00_320_boot)
HXDLIN( 320)		A_Y = false;
            	}
}
