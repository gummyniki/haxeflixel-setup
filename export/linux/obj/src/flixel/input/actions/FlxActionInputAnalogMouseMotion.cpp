...
HX_DEFINE_STACK_FRAME(_hx_pos_2807c6723785a0be_82_new,"flixel.input.actions.FlxActionInputAnalogMouseMotion","new",0x363469d4,"flixel.input.actions.FlxActionInputAnalogMouseMotion.new","flixel/input/actions/FlxActionInputAnalog.hx",82,0x00ad3122)
HX_LOCAL_STACK_FRAME(_hx_pos_2807c6723785a0be_115_update,"flixel.input.actions.FlxActionInputAnalogMouseMotion","update",0xab774d15,"flixel.input.actions.FlxActionInputAnalogMouseMotion.update","flixel/input/actions/FlxActionInputAnalog.hx",115,0x00ad3122)
HX_LOCAL_STACK_FRAME(_hx_pos_2807c6723785a0be_120_updateXYPosition,"flixel.input.actions.FlxActionInputAnalogMouseMotion","updateXYPosition",0xd2eb6c1f,"flixel.input.actions.FlxActionInputAnalogMouseMotion.updateXYPosition","flixel/input/actions/FlxActionInputAnalog.hx",120,0x00ad3122)
namespace flixel{
namespace input{
namespace actions{
...
void FlxActionInputAnalogMouseMotion_obj::__construct(int Trigger,::hx::Null< int >  __o_Axis,::hx::Null< int >  __o_PixelsPerUnit,::hx::Null< Float >  __o_DeadZone,::hx::Null< bool >  __o_InvertY,::hx::Null< bool >  __o_InvertX){
            	...
            	HX_STACKFRAME(&_hx_pos_2807c6723785a0be_82_new)
HXLINE(  85)		this->lastY = ((Float)0);
HXLINE(  84)		this->lastX = ((Float)0);
HXLINE( 103)		this->pixelsPerUnit = PixelsPerUnit;
HXLINE( 104)		if ((this->pixelsPerUnit < 1)) {
HXLINE( 105)			this->pixelsPerUnit = 1;
            		}
HXLINE( 106)		this->deadZone = DeadZone;
HXLINE( 107)		this->invertX = InvertX;
HXLINE( 108)		this->invertY = InvertY;
HXLINE( 109)		super::__construct(::flixel::input::actions::FlxInputDevice_obj::MOUSE_dyn(),-1,Trigger,Axis,null());
            	}
...
void FlxActionInputAnalogMouseMotion_obj::update(){
            	HX_STACKFRAME(&_hx_pos_2807c6723785a0be_115_update)
HXDLIN( 115)		this->updateXYPosition(( (Float)(::flixel::FlxG_obj::mouse->x) ),( (Float)(::flixel::FlxG_obj::mouse->y) ));
            	}


void FlxActionInputAnalogMouseMotion_obj::updateXYPosition(Float X,Float Y){
            	HX_STACKFRAME(&_hx_pos_2807c6723785a0be_120_updateXYPosition)
HXLINE( 121)		Float xDiff = (X - this->lastX);
HXLINE( 122)		Float yDiff = (Y - this->lastY);
HXLINE( 124)		this->lastX = X;
HXLINE( 125)		this->lastY = Y;
HXLINE( 127)		if (this->invertX) {
HXLINE( 128)			xDiff = (xDiff * ( (Float)(-1) ));
            		}
HXLINE( 129)		if (this->invertY) {
HXLINE( 130)			yDiff = (yDiff * ( (Float)(-1) ));
            		}
HXLINE( 132)		xDiff = (xDiff / ( (Float)(this->pixelsPerUnit) ));
HXLINE( 133)		yDiff = (yDiff / ( (Float)(this->pixelsPerUnit) ));
HXLINE( 135)		if ((::Math_obj::abs(xDiff) < this->deadZone)) {
HXLINE( 136)			xDiff = ( (Float)(0) );
            		}
HXLINE( 137)		if ((::Math_obj::abs(yDiff) < this->deadZone)) {
HXLINE( 138)			yDiff = ( (Float)(0) );
            		}
HXLINE( 140)		this->updateValues(xDiff,yDiff);
            	}
