...
HX_LOCAL_STACK_FRAME(_hx_pos_46dea4e2f301566f_385_getFirstSteamOrigin,"flixel.input.actions.FlxAction","getFirstSteamOrigin",0x6f5d528f,"flixel.input.actions.FlxAction.getFirstSteamOrigin","flixel/input/actions/FlxAction.hx",385,0xb046b220)
HX_LOCAL_STACK_FRAME(_hx_pos_46dea4e2f301566f_403_getSteamOrigins,"flixel.input.actions.FlxAction","getSteamOrigins",0x8a9d7ee6,"flixel.input.actions.FlxAction.getSteamOrigins","flixel/input/actions/FlxAction.hx",403,0xb046b220)
HX_LOCAL_STACK_FRAME(_hx_pos_46dea4e2f301566f_407_removeAll,"flixel.input.actions.FlxAction","removeAll",0x834d6510,"flixel.input.actions.FlxAction.removeAll","flixel/input/actions/FlxAction.hx",407,0xb046b220)
HX_LOCAL_STACK_FRAME(_hx_pos_46dea4e2f301566f_419_remove,"flixel.input.actions.FlxAction","remove",0x3279bc91,"flixel.input.actions.FlxAction.remove","flixel/input/actions/FlxAction.hx",419,0xb046b220)
HX_LOCAL_STACK_FRAME(_hx_pos_46dea4e2f301566f_431_toString,"flixel.input.actions.FlxAction","toString",0x9d225e39,"flixel.input.actions.FlxAction.toString","flixel/input/actions/FlxAction.hx",431,0xb046b220)
HX_LOCAL_STACK_FRAME(_hx_pos_46dea4e2f301566f_438_check,"flixel.input.actions.FlxAction","check",0x4ba8c11b,"flixel.input.actions.FlxAction.check","flixel/input/actions/FlxAction.hx",438,0xb046b220)
HX_LOCAL_STACK_FRAME(_hx_pos_46dea4e2f301566f_473_update,"flixel.input.actions.FlxAction","update",0xb4f6a656,"flixel.input.actions.FlxAction.update","flixel/input/actions/FlxAction.hx",473,0xb046b220)
HX_LOCAL_STACK_FRAME(_hx_pos_46dea4e2f301566f_477_destroy,"flixel.input.actions.FlxAction","destroy",0x2991500d,"flixel.input.actions.FlxAction.destroy","flixel/input/actions/FlxAction.hx",477,0xb046b220)
HX_LOCAL_STACK_FRAME(_hx_pos_46dea4e2f301566f_488_match,"flixel.input.actions.FlxAction","match",0x09157198,"flixel.input.actions.FlxAction.match","flixel/input/actions/FlxAction.hx",488,0xb046b220)
HX_LOCAL_STACK_FRAME(_hx_pos_46dea4e2f301566f_492_addGenericInput,"flixel.input.actions.FlxAction","addGenericInput",0x4a082847,"flixel.input.actions.FlxAction.addGenericInput","flixel/input/actions/FlxAction.hx",492,0xb046b220)
HX_LOCAL_STACK_FRAME(_hx_pos_46dea4e2f301566f_504_checkExists,"flixel.input.actions.FlxAction","checkExists",0x7f679957,"flixel.input.actions.FlxAction.checkExists","flixel/input/actions/FlxAction.hx",504,0xb046b220)
namespace flixel{
namespace input{
namespace actions{
...
HXLINE( 351)		this->steamOriginsChanged = false;
HXLINE( 346)		this->_checked = false;
HXLINE( 344)		this->_timestamp = 0;
HXLINE( 342)		this->_y = null();
HXLINE( 341)		this->_x = null();
HXLINE( 334)		this->triggered = false;
HXLINE( 329)		this->steamHandle = -1;
HXLINE( 360)		this->type = InputType;
HXLINE( 361)		this->name = Name;
HXLINE( 362)		this->inputs = ::Array_obj< ::Dynamic>::__new(0);
            	}
...
int FlxAction_obj::getFirstSteamOrigin(){
            	HX_STACKFRAME(&_hx_pos_46dea4e2f301566f_385_getFirstSteamOrigin)
HXDLIN( 385)		return 0;
            	}
...
::Array< int > FlxAction_obj::getSteamOrigins(::Array< int > origins){
            	HX_STACKFRAME(&_hx_pos_46dea4e2f301566f_403_getSteamOrigins)
HXDLIN( 403)		return origins;
            	}
...
void FlxAction_obj::removeAll(::hx::Null< bool >  __o_Destroy){
            	...
            	HX_STACKFRAME(&_hx_pos_46dea4e2f301566f_407_removeAll)
HXLINE( 408)		int len = this->inputs->length;
HXLINE( 409)		{
HXLINE( 409)			int _g = 0;
...
HXLINE( 411)				int j = ((len - i) - 1);
HXLINE( 412)				 ::flixel::input::actions::FlxActionInput input = this->inputs->__get(j).StaticCast<  ::flixel::input::actions::FlxActionInput >();
HXLINE( 413)				this->remove(input,Destroy);
HXLINE( 414)				this->inputs->removeRange(j,1);
            			}
            		}
            	}
...
void FlxAction_obj::remove( ::flixel::input::actions::FlxActionInput Input,::hx::Null< bool >  __o_Destroy){
            	...
            	HX_STACKFRAME(&_hx_pos_46dea4e2f301566f_419_remove)
HXLINE( 420)		if (::hx::IsNull( Input )) {
HXLINE( 421)			return;
            		}
HXLINE( 422)		this->inputs->remove(Input);
HXLINE( 423)		if (Destroy) {
HXLINE( 425)			Input->destroy();
            		}
            	}
...
::String FlxAction_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_46dea4e2f301566f_431_toString)
HXDLIN( 431)		::String _hx_tmp = ((HX_("FlxAction(",80,bd,59,96) + ::Std_obj::string(this->type)) + HX_(") name:",58,20,e0,0a));
HXDLIN( 431)		return (_hx_tmp + this->name);
            	}
...
bool FlxAction_obj::check(){
            	HX_STACKFRAME(&_hx_pos_46dea4e2f301566f_438_check)
HXLINE( 439)		if ((this->_timestamp == ::flixel::FlxG_obj::game->ticks)) {
HXLINE( 440)			return this->triggered;
            		}
HXLINE( 442)		this->_x = null();
HXLINE( 443)		this->_y = null();
HXLINE( 445)		this->_timestamp = ::flixel::FlxG_obj::game->ticks;
HXLINE( 446)		this->triggered = false;
HXLINE( 448)		int i;
HXDLIN( 448)		if (::hx::IsNotNull( this->inputs )) {
HXLINE( 448)			i = this->inputs->length;
            		}
            		else {
HXLINE( 448)			i = 0;
            		}
...
HXLINE( 451)			 ::flixel::input::actions::FlxActionInput input = this->inputs->__get(i).StaticCast<  ::flixel::input::actions::FlxActionInput >();
HXLINE( 453)			if (input->destroyed) {
HXLINE( 455)				this->inputs->remove(input);
HXLINE( 456)				continue;
            			}
HXLINE( 459)			input->update();
HXLINE( 461)			if (input->check(::hx::ObjectPtr<OBJ_>(this))) {
HXLINE( 462)				this->triggered = true;
            			}
            		}
            		_hx_goto_7:;
HXLINE( 465)		return this->triggered;
            	}
...
void FlxAction_obj::update(){
            	HX_STACKFRAME(&_hx_pos_46dea4e2f301566f_473_update)
HXDLIN( 473)		this->check();
            	}
...
void FlxAction_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_46dea4e2f301566f_477_destroy)
HXLINE( 478)		::flixel::util::FlxDestroyUtil_obj::destroyArray(this->inputs);
HXLINE( 479)		this->inputs = null();
            	}
...
bool FlxAction_obj::match( ::flixel::input::actions::FlxAction other){
            	HX_STACKFRAME(&_hx_pos_46dea4e2f301566f_488_match)
HXDLIN( 488)		if ((this->name == other->name)) {
HXDLIN( 488)			return (this->steamHandle == other->steamHandle);
            		}
            		else {
...
HX_DEFINE_DYNAMIC_FUNC1(FlxAction_obj,match,return )
 ...
 ::flixel::input::actions::FlxAction FlxAction_obj::addGenericInput( ::flixel::input::actions::FlxActionInput input){
            	HX_STACKFRAME(&_hx_pos_46dea4e2f301566f_492_addGenericInput)
HXLINE( 493)		if (::hx::IsNull( this->inputs )) {
HXLINE( 495)			this->inputs = ::Array_obj< ::Dynamic>::__new(0);
            		}
HXLINE( 497)		if (!(this->checkExists(input))) {
HXLINE( 498)			this->inputs->push(input);
            		}
...
bool FlxAction_obj::checkExists( ::flixel::input::actions::FlxActionInput input){
            	HX_STACKFRAME(&_hx_pos_46dea4e2f301566f_504_checkExists)
HXLINE( 505)		if (::hx::IsNull( this->inputs )) {
HXLINE( 506)			return false;
            		}
HXLINE( 507)		return this->inputs->contains(input);
            	}
