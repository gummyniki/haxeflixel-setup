...
HX_DEFINE_STACK_FRAME(_hx_pos_aa3e9b81dcfc3b35_54_new,"flixel.input.actions.FlxActionInputAnalogClickAndDragMouseMotion","new",0xa8f71c91,"flixel.input.actions.FlxActionInputAnalogClickAndDragMouseMotion.new","flixel/input/actions/FlxActionInputAnalog.hx",54,0x00ad3122)
HX_LOCAL_STACK_FRAME(_hx_pos_aa3e9b81dcfc3b35_60_updateValues,"flixel.input.actions.FlxActionInputAnalogClickAndDragMouseMotion","updateValues",0xe44ed07a,"flixel.input.actions.FlxActionInputAnalogClickAndDragMouseMotion.updateValues","flixel/input/actions/FlxActionInputAnalog.hx",60,0x00ad3122)
namespace flixel{
namespace input{
namespace actions{
...
void FlxActionInputAnalogClickAndDragMouseMotion_obj::__construct(int ButtonID,int Trigger,::hx::Null< int >  __o_Axis,::hx::Null< int >  __o_PixelsPerUnit,::hx::Null< Float >  __o_DeadZone,::hx::Null< bool >  __o_InvertY,::hx::Null< bool >  __o_InvertX){
            	...
            	HX_STACKFRAME(&_hx_pos_aa3e9b81dcfc3b35_54_new)
HXLINE(  55)		super::__construct(Trigger,Axis,PixelsPerUnit,DeadZone,InvertY,InvertX);
HXLINE(  56)		this->button = ButtonID;
            	}
...
void FlxActionInputAnalogClickAndDragMouseMotion_obj::updateValues(Float X,Float Y){
            	HX_STACKFRAME(&_hx_pos_aa3e9b81dcfc3b35_60_updateValues)
HXLINE(  61)		bool pass = false;
HXLINE(  63)		switch((int)(this->button)){
            			case (int)-3: {
HXLINE(  66)				 ::flixel::input::mouse::FlxMouseButton _this = ::flixel::FlxG_obj::mouse->_rightButton;
HXDLIN(  66)				if ((_this->current != 1)) {
HXLINE(  66)					pass = (_this->current == 2);
            				}
            				else {
HXLINE(  66)					pass = true;
            				}
            			...
            			break;
            			case (int)-2: {
HXLINE(  67)				 ::flixel::input::mouse::FlxMouseButton _this1 = ::flixel::FlxG_obj::mouse->_middleButton;
HXDLIN(  67)				if ((_this1->current != 1)) {
HXLINE(  67)					pass = (_this1->current == 2);
            				}
            				else {
HXLINE(  67)					pass = true;
            				}
            			...
            			break;
            			case (int)-1: {
HXLINE(  65)				 ::flixel::input::mouse::FlxMouseButton _this2 = ::flixel::FlxG_obj::mouse->_leftButton;
HXDLIN(  65)				if ((_this2->current != 1)) {
HXLINE(  65)					pass = (_this2->current == 2);
            				}
            				else {
HXLINE(  65)					pass = true;
            				}
...
HXLINE(  75)		this->super::updateValues(X,Y);
            	}
