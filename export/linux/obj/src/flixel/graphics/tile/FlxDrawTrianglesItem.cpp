...
HXLINE( 309)		this->uvtData->set((prevVerticesPos + 1),frame->uv->width);
HXLINE( 311)		{
...
HXLINE( 317)		this->uvtData->set((prevVerticesPos + 2),frame->uv->y);
HXLINE( 318)		this->uvtData->set((prevVerticesPos + 3),frame->uv->width);
HXLINE( 320)		{
...
HXLINE( 326)		this->uvtData->set((prevVerticesPos + 4),frame->uv->y);
