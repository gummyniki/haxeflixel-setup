...
HXDLIN( 461)			_this->advanced(((data + this->fontName) + HX_("\"",22,00,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true,::hx::SourceInfo(HX_("flixel/graphics/frames/FlxBitmapFont.hx",06,82,34,de),461,HX_("flixel.graphics.frames.FlxBitmapFont",79,e8,86,f0),HX_("setCharFrame",75,c1,2b,e4)));
            		}
...
HXLINE( 526)			::flixel::FlxG_obj::log->advanced(HX_("Invalid call to getFramesCollections on a destroyed graphic",1c,9c,0d,21),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true,::hx::SourceInfo(HX_("flixel/graphics/FlxGraphic.hx",17,35,63,b3),496,HX_("flixel.graphics.FlxGraphic",27,fc,ac,ae),HX_("getFramesCollections",d9,58,45,b4)));
