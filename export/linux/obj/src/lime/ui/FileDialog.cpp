...
HXLINE( 123)						_gthis->onCancel->dispatch();
            		...
            		HX_BEGIN_LOCAL_FUNC_S5(::hx::LocalFunc,_hx_Closure_1, ::lime::_hx_system::ThreadPool,worker,::Array< ::Dynamic>,type1,::String,filter,::Array< ::String >,title1,::String,defaultPath) HXARGC(2)
...
HXLINE( 142)			switch((int)(type1->__get(0).StaticCast<  ::lime::ui::FileDialogType >()->_hx_getIndex())){
            				case (int)0: {
HXLINE( 146)					if (::hx::IsNull( title1->__get(0) )) {
HXLINE( 146)						title1[0] = HX_("Open File",92,6a,32,1d);
            					}
HXLINE( 149)					::String path = null();
HXLINE( 151)					path = ( (::String)(( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_open_file(title1->__get(0),filter,defaultPath)) )) );
HXLINE( 154)					worker->sendComplete(path,null());
            				}
            				break;
            				case (int)1: {
HXLINE( 158)					if (::hx::IsNull( title1->__get(0) )) {
HXLINE( 158)						title1[0] = HX_("Open Files",a1,d5,ea,6e);
            					}
HXLINE( 161)					 ::hx::Object * paths = ::hx::DynamicPtr(null());
HXLINE( 174)					paths = ::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_open_files(title1->__get(0),filter,defaultPath);
HXLINE( 178)					worker->sendComplete(( ( ::Dynamic)(paths) ),null());
            				}
            				break;
            				case (int)2: {
HXLINE( 194)					if (::hx::IsNull( title1->__get(0) )) {
HXLINE( 194)						title1[0] = HX_("Save File",3f,02,ba,38);
            					}
HXLINE( 197)					::String path1 = null();
HXLINE( 199)					path1 = ( (::String)(( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_save_file(title1->__get(0),filter,defaultPath)) )) );
HXLINE( 202)					worker->sendComplete(path1,null());
            				}
            				break;
            				case (int)3: {
HXLINE( 182)					if (::hx::IsNull( title1->__get(0) )) {
HXLINE( 182)						title1[0] = HX_("Open Directory",97,c6,32,a3);
            					}
HXLINE( 185)					::String path2 = null();
HXLINE( 187)					path2 = ( (::String)(( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_open_directory(title1->__get(0),filter,defaultPath)) )) );
...
HXDLIN(  98)		::Array< ::String > title1 = ::Array_obj< ::String >::__new(1)->init(0,title);
...
HXLINE( 140)		worker->run( ::Dynamic(new _hx_Closure_1(worker,type1,filter,title1,defaultPath)),null());
...
HXLINE( 248)			if (::hx::IsNull( title1->__get(0) )) {
HXLINE( 248)				title1[0] = HX_("Open File",92,6a,32,1d);
            			}
HXLINE( 251)			::String path = null();
HXLINE( 253)			path = ( (::String)(( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_open_file(title1->__get(0),filter,defaultPath)) )) );
HXLINE( 256)			worker->sendComplete(path,null());
            		}
            		HX_END_LOCAL_FUNC2((void))

            	HX_GC_STACKFRAME(&_hx_pos_9e2e2667a273619d_225_open)
HXDLIN( 225)		::Array< ::String > title1 = ::Array_obj< ::String >::__new(1)->init(0,title);
...
HXLINE( 245)		worker->run( ::Dynamic(new _hx_Closure_1(worker,filter,title1,defaultPath)),null());
...
HXLINE( 311)			if (::hx::IsNull( title1->__get(0) )) {
HXLINE( 311)				title1[0] = HX_("Save File",3f,02,ba,38);
            			}
HXLINE( 314)			::String path = null();
HXLINE( 316)			path = ( (::String)(( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_save_file(title1->__get(0),filter,defaultPath)) )) );
...
HXDLIN( 282)		::Array< ::String > title1 = ::Array_obj< ::String >::__new(1)->init(0,title);
...
HXLINE( 308)		worker->run( ::Dynamic(new _hx_Closure_1(worker,filter,title1,defaultPath)),null());
